...
draw_sprite_ext(spr_editboxB_bars,image_index,x+10,y+10,(selfWidth-20)/sprite_get_width(spr_editboxB_bars),1,0,c_white,1);
...
for(i=0;i<global.reservesNumber;i++){
	draw_text(x+stringWidths+max(string_width(global.reservesNames[i])/2,sprite_get_width(spr_plusbutton)+5)+i*(10)+20,y+selfHeight-5-textHeight/2-sprite_get_height(spr_plusbutton),global.reservesNames[i]);
	if i>0 {
	...
	draw_sprite_ext(bar,image_index,x+stringWidths+string_width(global.reservesNames[i])/2+i*(10)+20,y+10+sprite_get_height(spr_editboxB_bars),1,ratio,0,c_white,1);
...
for(i=0;i<global.populationNumber;i++){
	draw_text(x+stringWidths+max(string_width(global.populationNames[i])/2,sprite_get_width(spr_plusbutton)+5)+(i+global.reservesNumber)*(10)+20,y+selfHeight-5-textHeight/2-sprite_get_height(spr_plusbutton),global.populationNames[i]);
	if i>0 {
	...
	draw_sprite_ext(bar,image_index,x+stringWidths+string_width(global.populationNames[i])/2+(i+global.reservesNumber)*(10)+20,y+10+sprite_get_height(spr_editboxB_bars),1,ratio,0,c_white,1);
